                        ...
                        <div class="d-sm-flex align-items-center flex-grow-1">
                            ...
                            <div class="mb-3 pb-1 w-100 mb-sm-4 me-sm-3">
                                ...
                                <select class="form-select rounded-0" id="from-destination">
                                    ...
                                    <option value="LIBRARY">연희대공원점(PLANT LIBRARY)</option>
                                    <option value="HOTEL">분당점(PLANT HOTEL)</option>
                                    <option value="LAB">광명점(PLANT LAB)</option>
                                    <option value="STATION">삼방점(PLANT STATION)</option>
	                            </select>
	                        </div>
	                        ...
	                        <div class="mb-3 pb-1 w-100 mb-sm-4 me-sm-3">
	                            ...
	                            <select class="form-select rounded-0" id="to-destination">
	                                ...
	                                <option value="PlantHotel" selected >가든어스</option>
	                            </select>
	                        </div>
