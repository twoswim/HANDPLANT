	                ...
	                <div class="row">
	                    ...
	                    <div style="margin-top: 130px">
	                                    ...
	                                    <div class="d-flex align-items-center me-grid-gutter">
	                                        <div class="ps-2">
	                                            ...
	                                            <div class="text-nowrap">
	                                                <div class="meta-link fs-xs"><i class="ai-calendar me-1 align-vertical"></i>&nbsp;Nov 23, 2021</div>
	                        ...
	                        <nav class="d-flex justify-content-between pb-4 mb-5" aria-label="Entry navigation">
	                            ...
	                            <a class="entry-nav ms-3" href="<%=request.getContextPath()%>/views/html/3_news03.jsp">
