			       ...
			       <form class="col-lg-4 mb-4 mb-lg-0 " action="<%=request.getContextPath()%>/board/list" method="get">
                       <div class="bg-light rounded-0 shadow-lg ">
                           ...
                           <div class="d-lg-block collapse pb-2 " id="account-menu ">
                               ...
                               <a id="ajaxFre" class="d-flex align-items-center px-4 py-3 border-top "style="color:#766df4" href="<%=request.getContextPath()%>/board/list">
                       ...
                       <div class="d-flex flex-column h-100 bg-light rounded-0 shadow-lg p-4 ">
                           <div class="py-2 p-md-3 ">
							...
							<%-- 페이지부 시작 --%>
							   ...
							   <%-- 이전으로 가기 --%>	
							       <li class="page-item page-link" onclick="movePage('<%=path%>/board/listFre?page=<%=pageInfo.getPrvePage()%>');">
								   ...
								   <% for(int i = pageInfo.getStartPage(); i <= pageInfo.getEndPage(); i++){ %>
									   ...
									   <%} else {%>
									   <li class="page-item active d-none d-sm-block page-link" onclick="movePage('<%=path%>/board/listFre?page=<%=i%>');"> <%=i%></li>
									   <%} %>
								   <%} %>
								<%-- 다음으로 가기 --%>	
								<li class="page-item page-link " onclick="movePage('<%=path%>/board/listFre?page=<%=pageInfo.getNextPage()%>');">
