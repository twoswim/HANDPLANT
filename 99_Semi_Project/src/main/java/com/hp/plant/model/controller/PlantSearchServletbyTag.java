...
@WebServlet("/plant/list/tag")
public class PlantSearchServletbyTag extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			String searchValue = req.getParameter("searchValue2");
			if(searchValue != null && searchValue.length() > 0) {
				String searchType = "pTag";
